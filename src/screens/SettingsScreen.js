...
const styles = StyleSheet.create({
  ...
  title: { fontSize: 22, fontWeight: '800', color: COLORS.GOLD, marginBottom: 28, textAlign: 'center' },
  sectionTitle: { fontSize: 15, fontWeight: '700', color: COLORS.TEXT_PRIMARY, marginBottom: 4 },
  sectionDesc: { fontSize: 12, color: COLORS.TEXT_MUTED, marginBottom: 14 },
  ...
  optInfo: { flex: 1 },
  optName: { fontSize: 15, fontWeight: '600', color: COLORS.TEXT_PRIMARY },
  optNameSel: { color: COLORS.GOLD },
  optDesc: { fontSize: 12, color: COLORS.TEXT_MUTED, marginTop: 2, lineHeight: 16 },
